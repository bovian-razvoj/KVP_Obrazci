...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#modal-btn-save-add-attachment").on("click", function () {
            ...
            if (saveKVPAndOpenAttachmentTab) {
                ...
                //$('.nav-tabs a[href="#Attachments"]').tab('show');
                $('#KVPBasicData').removeClass('active');
        ...
        function SaveStatus_Click(s, e) {
            ...
            var memoFields = [clientMemoOpombe];
            process = InputFieldsValidation(lookupItems, null, null, memoFields, null, null);
            if (process) {
                clientLoadingPanel.Show();
        ...
        function CallbackPanelKVPDocumentForm_EndCallback(s, e) {
            if (s.cpStatusHistory != "" && s.cpStatusHistory !== undefined) {
                ...
                ShowRejectModal(s.cpRejectArguments);
        ...
        function clientBtnPrenosRdeciKarton_Click(s, e) {
            var memoFields = [clientMemoProblemDesc, clientMemoImprovementProposition];
            var lookupItems = [lookUpProposer, lookUpLeaderTeam, lookUpDepartment, lookUpLocation];
            ...
            if (process) {
                ...
                lookUpMachine.SetEnabled(true);
                lookUpLine.SetEnabled(true);

                $('.nav-tabs a[href="#KVPBasicData"]').tab('show');
            }
        }

        function clientBtnPrint_Click(s, e) {
            clientLoadingPanel.Show();
            clientCallbackPanelKVPDocumentForm.PerformCallback('PrintDocument');
        }
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <ul class="nav nav-tabs" runat="server" id="navTabs">
                            ...
                            <li runat="server" id="cipItem" class="hidden">
                        ...
                        <div class="tab-content">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row2" style="align-items: center">
                                                            ...
                                                            <div class="col-sm-12 no-padding-left">
                                                                ...
                                                                <div class="col-xs-12">
                                                                    <dx:ASPxHtmlEditor ID="ASPxHtmlEditorCIP" runat="server" Width="100%" CssClass="text-box-input">
                                                                        <Settings AllowHtmlView="false" AllowPreview="true"></Settings>
                                                                    </dx:ASPxHtmlEditor>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-7 no-padding-left">
                                                        <dx:ASPxGridLookup ID="ASPxGridLookupStatus" runat="server" ClientInstanceName="lookUpStatus"
                                                            ...
                                                            <GridViewProperties>
                                                                <SettingsBehavior EnableRowHotTrack="True" />
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" AllowEllipsisInText="true" AutoFilterRowInputDelay="8000" />
                                                                <SettingsPager ShowSeparators="True" AlwaysShowPager="False" ShowNumericButtons="False" NumericButtonCount="3" Mode="ShowAllRecords" />
                                                                <Settings ShowFilterRow="True" ShowFilterRowMenu="True" ShowPreview="True" ShowVerticalScrollBar="True"
                                                ...
                                                <div class="row2" style="align-items: center">
                                                    ...
                                                    <div class="col-sm-12 no-padding-left">
                                                        <dx:ASPxMemo ID="ASPxMemoOpombe" runat="server" Width="100%" MaxLength="300"
                                                            NullText="Razlog za spreminjanje statusa..." Rows="3" HorizontalAlign="Left" BackColor="White"
                            ...
                            <dx:XpoDataSource ID="XpoDataSourceKVPAuditors" runat="server" ServerMode="True"
                                DefaultSorting="ts DESC" TypeName="KVP_Obrazci.Domain.KVPOdelo.KVPPresoje" Criteria="[idKVPDocument.idKVPDocument] = ?">
                                <CriteriaParameters>
                            ...
                            <div class="AddEditButtonsWrap">
                                ...
                                <span class="AddEditButtons">
                                    <dx:ASPxButton ID="btnPrenosRdeciKarton" runat="server" Text="Prenos v rdeči karton" AutoPostBack="false"
                                        Height="30" Width="50" UseSubmitBehavior="false" OnClick="btnPrenosRdeciKarton_Click"
                                        ClientVisible="false" ClientInstanceName="clientBtnPrenosRdeciKarton" ClientEnabled="true">
                                        <ClientSideEvents Click="clientBtnPrenosRdeciKarton_Click" />
                                        <Paddings PaddingLeft="10" PaddingRight="10" />
                                ...
                                <span class="AddEditButtons">
                                    <dx:ASPxButton ID="btnPrint" runat="server" Text="Natisni KVP" AutoPostBack="false"
                                        Height="30" Width="50" UseSubmitBehavior="false" ClientVisible="false"
                                        ClientInstanceName="clientBtnPrint">
                                        <Paddings PaddingLeft="10" PaddingRight="10" />
                                        <ClientSideEvents Click="clientBtnPrint_Click" />
            ...
            <div class="modal-dialog modal-sm vertical-align-center">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="display: grid;">
                        <button type="button" class="btn btn-default" style="margin-bottom: 10px;" id="modal-btn-save">Shrani in zapri KVP</button>
                        <button type="button" class="btn btn-primary" style="margin-bottom: 10px;" id="modal-btn-submit">Oddaj KVP</button>
                        <button type="button" class="btn btn-info" id="modal-btn-save-add-attachment">Shrani in dodaj prilogo</button>
                    </div>
                </div>
            </div>
        </div>
