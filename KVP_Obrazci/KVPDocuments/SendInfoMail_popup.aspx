...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row2 small-padding-bottom small-padding-top" style="align-items: center">
        ...
        <div class="col-xs-10 no-padding-left">
            <dx:ASPxGridLookup ID="ASPxGridLookupEmployee" runat="server" ClientInstanceName="lookUpEmployee" SelectionMode="Multiple" MultiTextSeparator=", "
                ...
                <Columns>
                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" Width="80px" />
    ...
    <dx:XpoDataSource ID="XpoDSEmployee" runat="server" ServerMode="false"
