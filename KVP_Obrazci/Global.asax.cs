    ...
    public class Global_asax : System.Web.HttpApplication
    {
        ...
        protected void Application_PostAuthenticateRequest(object sender, EventArgs e)
        {
            ...
            if (authCookie != null)
            {
                ...
                userPrincipal.SecondRole = serializeModel.SecondRole;
                userPrincipal.SecondRoleID = serializeModel.SecondRoleID;
                userPrincipal.SecondRoleName = serializeModel.SecondRoleName;
