...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function gridMachine_OnSelectionChanged(s, e) {
            if (s.GetSelectedRowCount() > 0) {
                clientBtnbtnDeactiveChanges.SetVisible(true);
                clientBtnbtnActiveChanges.SetVisible(true);
            }
            else {
                clientBtnbtnDeactiveChanges.SetVisible(false);
                clientBtnbtnActiveChanges.SetVisible(false);
            }
        }
                ...
                <div class="row2">
                    <div class="col-xs-6">
                            ...
                            <div id="Machine" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <dx:ASPxGridView ID="ASPxGridViewMachine" runat="server" AutoGenerateColumns="False" Settings-ShowHeaderFilterButton="true"
                                        ...
                                        <ClientSideEvents RowDblClick="RowDoubleClick" BatchEditRowValidating="gridMachine_BatchEditRowValidating" SelectionChanged="gridMachine_OnSelectionChanged" />
                                        ...
                                        <Columns>
                                            <dx:GridViewCommandColumn ShowSelectCheckbox="true" Width="50px" SelectAllCheckboxMode="AllPages" Caption="Izberi" ShowClearFilterButton="true" Visible="true" />

                                            <dx:GridViewDataTextColumn Caption="Aktiven" FieldName="Active" Width="10%"
                        ...
                        <dx:XpoDataSource ID="XpoDSMachine" runat="server" ServerMode="True"
                            DefaultSorting="Active desc, idStroj" TypeName="KVP_Obrazci.Domain.KVPOdelo.Stroj">
                        </dx:XpoDataSource>
                    ...
                    <div class="col-xs-6 align-item-centerV-centerH">
                        <div class="AddEditButtonsElements clearFloatBtns">
                            <span class="AddEditButtons">
                                <dx:ASPxButton ID="btnConfirmChanges" runat="server" Text="Aktiviraj" AutoPostBack="false"
                                    Height="30" Width="50" ValidationGroup="Confirm" ClientInstanceName="clientBtnbtnActiveChanges"
                                    UseSubmitBehavior="false" ClientVisible="false" OnClick="btnActiveChanges_Click">
                                    <Paddings PaddingLeft="10" PaddingRight="10" />
                                </dx:ASPxButton>
                            </span>

                            <span class="AddEditButtons">
                                <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Deaktiviraj" AutoPostBack="false"
                                    Height="30" Width="50" ValidationGroup="Confirm" ClientInstanceName="clientBtnbtnDeactiveChanges"
                                    UseSubmitBehavior="false" ClientVisible="false" OnClick="btnDeactiveChanges_Click">
                                    <Paddings PaddingLeft="10" PaddingRight="10" />
                                </dx:ASPxButton>
                            </span>
                        </div>
