...
namespace KVP_Obrazci.CodeList.Machine
{
    public partial class Machine : ServerMasterPage
    {
        ...
        {
            List<int> selectedMachines = ASPxGridViewMachine.GetSelectedFieldValues("idStroj").OfType<int>().ToList();

            machineRepo.UpdateMachine(selectedMachines, false);

            ASPxGridViewMachine.Selection.UnselectAll();
        ...
        protected void btnActiveChanges_Click(object sender, EventArgs e)
        {
            ...
            machineRepo.UpdateMachine(selectedMachines, true);
