<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PopUp.Master" AutoEventWireup="true" CodeBehind="Location_popup.aspx.cs" Inherits="KVP_Obrazci.CodeList.Location.Location_popup" %>
    ...
    <div class="row2 small-padding-bottom small-padding-top align-item-centerV-startH">
        ...
        <div class="col-xs-6 no-padding-left">
            <dx:ASPxTextBox runat="server" ID="txtSort" ClientInstanceName="clientTxtSort"
                CssClass="text-box-input" Font-Size="13px" Width="100%" Font-Bold="true" AutoCompleteType="Disabled" ReadOnly="true" BackColor="LightGray">
