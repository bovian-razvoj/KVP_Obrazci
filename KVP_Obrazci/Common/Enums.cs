...
namespace KVP_Obrazci.Common
{
    public class Enums
    {
        ...
        public enum CommonSession
        {
            ...
            RedCardDocumentIDsToShow,
            RedCardDocumentNextPreviousID
        }
        ...
        public enum RedCardNumberingType
        {
            System,
            Manual
        }
