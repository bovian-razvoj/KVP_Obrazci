...
namespace KVP_Obrazci.Employees
{
    public partial class EmployeesForm : ServerMasterPage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            XpoDataSourceKVPPayout.Session = session;
        ...
        {
            XpoDataSourceKVPPayout.Criteria = "[LastStatusId] = 11 AND ([Predlagatelj.Id] = " + employeeID + " or [Realizator.Id] = " + employeeID + ")";

            txtPersonalID.Text = model.ExternalId;
        ...
        protected void btnExportToExcelKVPPayouts_Click(object sender, EventArgs e)
        {
            ASPxGridViewKVPPayoutsExporter.FileName = "KVPPayouts_" + CommonMethods.GetTimeStamp();
            ASPxGridViewKVPPayoutsExporter.WriteXlsxToResponse();
        }
    }
}