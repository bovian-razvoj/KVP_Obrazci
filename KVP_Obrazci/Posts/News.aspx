...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div class="row2">
        <div class="col-xs-12">
            <dx:ASPxCallbackPanel ID="CallbackPanelKVPDocumentForm" runat="server" Width="100%" ClientInstanceName="clientCallbackPanelKVPDocumentForm">
                <SettingsLoadingPanel Enabled="false" />
                <PanelCollection>
                    <dx:PanelContent>
                        <ul class="nav nav-tabs" id="navTabs">
                            <li id="posts" class="active"><a data-toggle="tab" href="#Posts"><span id="PostsBadge" runat="server" class="badge hidden">0</span> Novice</a></li>
                            <li id="userManual" runat="server"><a data-toggle="tab" href="#UserManual"><span id="UserManualBadge" runat="server" class="badge">0</span> Navodila</a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div id="UserManual" class="tab-pane fade">
                                <div class="panel panel-default" style="margin-top: 10px;">
                                    <div class="panel-heading">
                                        <h4 class="panel-title" style="display: inline-block;">Seznam navodil</h4>
                                    </div>
                                    <div class="panel-body" id="active-drop-zone">
                                        <widget:UploadAttachment ID="UserManualUploadControl" runat="server" OnPopulateAttachments="UserManualUploadControl_PopulateAttachments"
                                            OnUploadComplete="UserManualUploadControl_UploadComplete" OnDeleteAttachments="UserManualUploadControl_DeleteAttachments"
                                            OnDownloadAttachments="UserManualUploadControl_DownloadAttachments" UploadDirectory="~/Documents/"
                                            WebsiteDocumentContainerID="ctl00_ContentPlaceHolderMain_CallbackPanelKVPDocumentForm_UserManualUploadControl_documentContainer" 
                                            ReplaceFileInDestination="true" />
                                    </div>
                                </div>
                            </div>
                        </div>
