...
namespace KVP_Obrazci.Domain.Abstract
{
    public interface IPlaningAndRealizationRepository
    {
        ...
        decimal GetPlanNumberByKVPGroupMonthAndYear(int kvpGroupID, int month, int year, Session currentSession = null);
        void OpenNewYear(int year, Session currentSession = null);
    }
}
