...
namespace KVP_Obrazci.Payouts
{
    public partial class PayoutOverviewByPeriod : ServerMasterPage
    {
        ...
        private void GenerateColumns(bool createDataSource = true)
        {
            ...
            if (createDataSource)
            {
                list = payoutRepo.GetPayoutsByPeriod(DateEditDateFrom.Date, DateEditDateTo.Date, ASPxGridLookupEmployee.Text);
            ...
            textColumn.Settings.AllowAutoFilter = DevExpress.Utils.DefaultBoolean.True;
            ...
            {
                textColumn = new GridViewDataTextColumn();
                textColumn.Caption = "Vsota točk skozi obdobje";
