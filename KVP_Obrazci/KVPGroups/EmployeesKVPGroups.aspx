...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function CallbackPanelEmployeesKVPGroups_EndCallback(s, e) {
            ...
            if (s.cpIsDeleted != "" && s.cpIsDeleted != undefined)
            {
                $('.nav-tabs a[href="#EmployeesKVPGroupRemove"]').tab('show');
                delete (s.cpIsDeleted);
            }
        }
                                        ...
                                        <div class="col-sm-9">
                                            <dx:ASPxGridView ID="ASPxGridViewEmployees" runat="server" EnableCallbackCompression="true"
                                                ...
                                                <SettingsPager PageSize="50" ShowNumericButtons="true">
                                                    <PageSizeItemSettings Visible="true" Items="100,150,200" Caption="Zapisi na stran : " AllItemText="Vsi">
                                        ...
                                        <div class="col-sm-3">
                                            <dx:ASPxGridLookup ID="ASPxGridLookupKVPGroups" runat="server" ClientInstanceName="lookUpKVPGroups"
                                                ...
                                                <GridViewProperties>
                                                    ...
                                                    <SettingsPager ShowSeparators="True" AlwaysShowPager="True" ShowNumericButtons="true" NumericButtonCount="3" PageSize="50" />
                                        ...
                                        <div class="col-sm-9">
                                            <dx:ASPxGridView ID="ASPxGridViewEmployeesToRemove" runat="server" EnableCallbackCompression="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataDateColumn Caption="Datum prihoda"
                                                        FieldName="IdUser.TAStartDate" ShowInCustomizationForm="True"
                                                        Width="100px" ExportWidth="120">
                                                        <PropertiesDateEdit DisplayFormatString="dd.MM. yyyy" />
                                                        <Settings AllowAutoFilter="True" AutoFilterCondition="Contains" />
                                                    </dx:GridViewDataDateColumn>
