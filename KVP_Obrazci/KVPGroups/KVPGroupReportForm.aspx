                                    ...
                                    <div class="row small-padding-bottom">
                                        <div class="col-xs-12">
                                            ...
                                            <dx:ASPxGridView ID="ASPxGridViewKVPGroupReport1" runat="server" EnableCallbackCompression="true"
                                                ...
                                                OnHtmlRowPrepared="ASPxGridViewKVPGroupReport1_HtmlRowPrepared">
                                                <Paddings Padding="5px" />
                                                <Settings ShowVerticalScrollBar="True" HorizontalScrollBarMode="Auto"
                                                    ShowFilterBar="Auto" ShowFilterRow="True" VerticalScrollableHeight="520"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Realizirani/zaključeni KVP-ji" FieldName="Realizirani" Width="140px" ShowInCustomizationForm="True"
                                                        Visible="false">
                                                        <Settings AllowAutoFilter="True" AutoFilterCondition="Contains" />
                                                    </dx:GridViewDataTextColumn>
