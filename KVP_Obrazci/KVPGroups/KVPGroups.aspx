                ...
                <div id="kvpGroups" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <dx:ASPxGridView ID="ASPxGridViewKVPGroups" runat="server" EnableCallbackCompression="true"
                            ...
                            OnDataBound="ASPxGridViewKVPGroups_DataBound" OnBatchUpdate="ASPxGridViewKVPGroups_BatchUpdate">
                            ...
                            <SettingsBehavior AllowFocusedRow="true" AutoFilterRowInputDelay ="8000"/>
                            <Styles Header-Wrap="True">
                                <Header Paddings-PaddingTop="5" HorizontalAlign="Center" VerticalAlign="Middle" Font-Bold="true"></Header>
                                <FocusedRow BackColor="#d1e6fe" Font-Bold="true" ForeColor="#606060"></FocusedRow>
                            </Styles>
                            <SettingsText EmptyDataRow="Trenutno ni podatka o skupinah. Dodaj novo." CommandBatchEditUpdate="Spremeni" CommandBatchEditCancel="Prekliči" />
                             <SettingsEditing Mode="Batch" BatchEditSettings-StartEditAction="Click" />
                            <Columns>

                                <dx:GridViewDataCheckColumn Caption="Aktivnost" FieldName="Aktivnost" Width="120px">
                                ...
                                <dx:GridViewDataTextColumn Caption="Naziv"
                                    ...
                                    Width="65%" EditFormSettings-Visible="False">
                                    <Settings AllowAutoFilter="True" AutoFilterCondition="Contains" />
                                </dx:GridViewDataTextColumn>
