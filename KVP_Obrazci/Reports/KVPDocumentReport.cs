...
{
    public partial class KVPDocumentReport : DevExpress.XtraReports.UI.XtraReport
    {

        public KVPDocument kvpDoc { get; set; }

        public KVPDocumentReport(int idKVPDocument, string reportOpenedBy = "")
        {
            InitializeComponent();
            ...
            kvpDocumentID_param.Value = idKVPDocument;
            ...
            var obj = kvpRepo.GetKVPByID(idKVPDocument);
            kvpDoc = obj;
