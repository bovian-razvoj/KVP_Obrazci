...
namespace KVP_Obrazci.Domain.Abstract
{
    public interface IPayoutsRepository
    {
        ...
        void SavePayoutsForNewMonth(List<Izplacila> payouts, DateTime date);
        ...
        List<PayoutOverviewByPeriodModel> GetPayoutsByPeriod(DateTime firstDate, DateTime lastDate);
    }
}
