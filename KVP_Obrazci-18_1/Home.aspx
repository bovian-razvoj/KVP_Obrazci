    ...
    <div id="FormLayoutWrap" runat="server" style="display: flex; width: 50%; margin: 0 auto; overflow: hidden; padding: 10px; border: 1px solid #e1e1e1; border-radius: 3px; box-shadow: 5px 10px 18px #e1e1e1; background-color: whitesmoke; margin-top: 30px;">
        <dx:ASPxFormLayout ID="ASPxFormLayoutLogin" runat="server">
            ...
            <Items>
                ...
                <dx:LayoutGroup Name="LOGIN" GroupBoxDecoration="HeadingLine" Caption="Prijava z ključkom" UseDefaultPaddings="false" GroupBoxStyle-Caption-BackColor="WhiteSmoke" ClientVisible="false">
                    <Items>
                    ...
                    <div class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <dx:ASPxButton ID="ASPxButton3" runat="server" Text="Nov KVP" RenderMode="Button" ImagePosition="Top" CssClass="instruction-buttons tasks-buttons"
                                ...
                                <dx:ASPxButton ID="ASPxButton4" runat="server" Text="Nov Rdeči karton" RenderMode="Button" ImagePosition="Top" CssClass="instruction-buttons tasks-buttons"
                                    AutoPostBack="false" UseSubmitBehavior="false" Enabled="false" Width="180px">
                                ...
                                <dx:ASPxButton ID="ASPxButton5" runat="server" Text="Moji KVP-ji" RenderMode="Button" ImagePosition="Top" CssClass="instruction-buttons tasks-buttons"
                                    AutoPostBack="false" UseSubmitBehavior="false" Width="180px">
                        ...
                        <div class="panel panel-default" style="display: none;" id="kodeksChanges" runat="server">
                            <div class="panel-heading">Spremembe KODEKS</div>
                            <div class="panel-body">
